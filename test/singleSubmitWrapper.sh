...
do
    ...
    condor_submit singleWrapper.sub -append "Arguments = ${dir} ${cms} ${sarch} ${i}" "transfer_input_files = /home/bloomcap3/$dir, /home/bloomcap3/$dir/PSetDump.py, ../PSets/psetB.py, ../WMCore/SetupPSet.py" "transfer_output_files = jobreport$i.xml, jobreportA$i.xml, jobreportB$i.xml" "Error = singleWrapper/err.$i" "Output = singleWrapper/out.$i" "Log = singleWrapper/log.$i" 
